...
public final class CTREConfigs {
    ...
    public TalonSRXConfiguration swerveCANcoderConfig = new TalonSRXConfiguration();

    public CTREConfigs(){
        /** Swerve CANCoder Configuration */
        var motorConfigs = new MotorOutputConfigs();
        motorConfigs.Inverted = InvertedValue.Clockwise_Positive;
        //swerveCANcoderConfig.FeedbackDevice.SensorDirection = Constants.Swerve.cancode;
